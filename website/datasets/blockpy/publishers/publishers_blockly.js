...
var publishers_PROPERTIES = [
    ["genre", "genre"] ,
    ["sold by", "sold by"] ,
    ["daily average.amazon revenue", "daily average.amazon revenue"] ,
    ["daily average.author revenue", "daily average.author revenue"] ,
    ["daily average.gross sales", "daily average.gross sales"] ,
    ["daily average.publisher revenue", "daily average.publisher revenue"] ,
    ["daily average.units sold", "daily average.units sold"] ,
    ["publisher.name", "publisher.name"] ,
    ["publisher.type", "publisher.type"] ,
    ["statistics.average rating", "statistics.average rating"] ,
    ["statistics.sale price", "statistics.sale price"] ,
    ["statistics.sales rank", "statistics.sales rank"] ,
    ["statistics.total reviews", "statistics.total reviews"] 
]
...
BlockMirrorTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['publishers'] = {
    "get": {
        custom: function(node, parent) {
            ...
            return BlockMirrorTextToBlocks.create_block("publishers_get", null,
