...
var police_shootings_INDEXES = [
    ["(None)", "(None)"],
    
    ["Incident.Date.Full", "Incident.Date.Full"] ,
    ["Incident.Location.State", "Incident.Location.State"] 
];

var police_shootings_INDEX_VALUES = {
    "(None)": [],
...
var police_shootings_PROPERTIES = [
    ["Person.Name", "Person.Name"] ,
    ["Person.Age", "Person.Age"] ,
    ["Person.Gender", "Person.Gender"] ,
    ["Person.Race", "Person.Race"] ,
    ["Incident.Date.Month", "Incident.Date.Month"] ,
    ["Incident.Date.Day", "Incident.Date.Day"] ,
    ["Incident.Date.Year", "Incident.Date.Year"] ,
    ["Incident.Date.Full", "Incident.Date.Full"] ,
    ["Incident.Location.City", "Incident.Location.City"] ,
    ["Incident.Location.State", "Incident.Location.State"] ,
    ["Factors.Armed", "Factors.Armed"] ,
    ["Factors.Mental-Illness", "Factors.Mental-Illness"] ,
    ["Factors.Threat-Level", "Factors.Threat-Level"] ,
    ["Factors.Fleeing", "Factors.Fleeing"] ,
    ["Shooting.Manner", "Shooting.Manner"] ,
    ["Shooting.Body-Camera", "Shooting.Body-Camera"] 
]

Blockly.Blocks['police_shootings_get'] = {
  init: function() {
    this.setColour(45);
    this.appendDummyInput('MAIN')
        .appendField("police_shootings.get")
        .appendField(new Blockly.FieldDropdown(police_shootings_PROPERTIES), "PROPERTY");
    this.appendDummyInput('SECOND')
        .appendField("filter")
        .appendField(new Blockly.FieldDropdown(police_shootings_INDEXES, function(option) {
                        this.getSourceBlock().updateShape_(option);
                    }), "INDEX")
    this.updateShape_("(None)");
    this.setInputsInline(false);
    this.setOutput(true, "Array");
    this.setTooltip('Returns a list of police shootings data.');
  },
  mutationToDom: function() {
    var container = document.createElement('mutation');
    container.setAttribute('index', this.getFieldValue('INDEX'));
    container.setAttribute('index_value', this.getFieldValue('INDEX_VALUE'));
    container.setAttribute('module', "police_shootings")
    return container;
  },
  ...
  updateShape_: function(index, index_value) {
    ...
    if (index != undefined && index != '(None)') {
        inputGroup.appendField(new Blockly.FieldDropdown(police_shootings_INDEX_VALUES[index]), 'INDEX_VALUE')
        if (index_value != undefined) {
            this.setFieldValue(index_value, 'INDEX_VALUE');
        } else {
            this.setFieldValue(police_shootings_INDEX_VALUES[index][0][0], 'INDEX_VALUE');
        }
    }    
  }
};
Blockly.Python['police_shootings_get'] = function(block) {
    Blockly.Python.definitions_['import_police_shootings'] = 'import police_shootings';
    ...
    var code = 'police_shootings.get('+property+',' +index+','+index_value+')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};

BlockMirrorTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['police_shootings'] = {
    "get": {
        custom: function(node, parent) {
            ...
            return BlockMirrorTextToBlocks.create_block("police_shootings_get", null,
