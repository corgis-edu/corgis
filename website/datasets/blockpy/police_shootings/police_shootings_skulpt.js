...
var $builtinmodule = function(name)
{
    ...
    mod.get_shootings = new Sk.builtin.func(function() {
        Sk.builtin.pyCheckArgs("get_shootings", arguments, 0, 0);
        if (!("police_shootings" in blockpy._IMPORTED_COMPLETE_DATASETS)) {
            alert("This library has not finished loading yet. Please wait about 10 seconds and try again.")
        } else {
            return Sk.ffi.remapToPy(blockpy._IMPORTED_COMPLETE_DATASETS["police_shootings"]);
        }
    });
