...
var supreme_court_PROPERTIES = [
    ...
    ["decision.authority 1", "decision.authority 1"] ,
    ["decision.authority 2", "decision.authority 2"] ,
    ...
    ["arguments.date argued.day", "arguments.date argued.day"] ,
    ["arguments.date argued.full", "arguments.date argued.full"] ,
    ["arguments.date argued.month", "arguments.date argued.month"] ,
    ["arguments.date argued.year", "arguments.date argued.year"] ,
    ["arguments.date reargued.day", "arguments.date reargued.day"] ,
    ["arguments.date reargued.full", "arguments.date reargued.full"] ,
    ["arguments.date reargued.month", "arguments.date reargued.month"] ,
    ["arguments.date reargued.year", "arguments.date reargued.year"] ,
    ["arguments.petitioner.entity", "arguments.petitioner.entity"] ,
    ["arguments.petitioner.id", "arguments.petitioner.id"] ,
    ["arguments.petitioner.state", "arguments.petitioner.state"] ,
    ["arguments.respondent.entity", "arguments.respondent.entity"] ,
    ["arguments.respondent.id", "arguments.respondent.id"] ,
    ["arguments.respondent.state", "arguments.respondent.state"] ,
    ["decision.admin action.agency", "decision.admin action.agency"] ,
    ["decision.admin action.id", "decision.admin action.id"] ,
    ["decision.admin action.state", "decision.admin action.state"] ,
    ...
    ["decision.date.year", "decision.date.year"] ,
    ["natural court.end.day", "natural court.end.day"] ,
    ["natural court.end.full", "natural court.end.full"] ,
    ["natural court.end.month", "natural court.end.month"] ,
    ["natural court.end.year", "natural court.end.year"] ,
    ["natural court.start.day", "natural court.start.day"] ,
    ["natural court.start.full", "natural court.start.full"] ,
    ["natural court.start.month", "natural court.start.month"] ,
    ["natural court.start.year", "natural court.start.year"] ,
    ["voting.majority assigner.id", "voting.majority assigner.id"] ,
    ["voting.majority assigner.long name", "voting.majority assigner.long name"] ,
    ["voting.majority assigner.name", "voting.majority assigner.name"] ,
    ["voting.majority writer.id", "voting.majority writer.id"] ,
    ["voting.majority writer.long name", "voting.majority writer.long name"] ,
