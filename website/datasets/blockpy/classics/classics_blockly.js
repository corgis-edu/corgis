...
var classics_INDEXES = [
    ...
    ["bibliography.author.name", "bibliography.author.name"] 
];
...
var classics_INDEX_VALUES = {
    ...
    "bibliography.author.name": [
        ...
        ["Dargan, Olive Tilford", "Dargan, Olive Tilford"] ,
        ...
        ["Dillmont, Therese de", "Dillmont, Therese de"] ,
        ...
        ["Ellis, Edward Sylvester", "Ellis, Edward Sylvester"] ,
        ...
        ["Figueiredo, Candido de", "Figueiredo, Candido de"] ,
        ...
        ["Guillaume, de Lorris, active 1230", "Guillaume, de Lorris, active 1230"] ,
        ...
        ["Kleiser, Grenville", "Kleiser, Grenville"] ,
        ...
        ["Malory, Thomas, Sir", "Malory, Thomas, Sir"] ,
        ...
        ["Mendeleyev, Dmitry Ivanovich", "Mendeleyev, Dmitry Ivanovich"] ,
        ...
        ["Popular Mechanics Company", "Popular Mechanics Company"] ,
        ...
        ["Rachinskii, Sergei Aleksandrovich", "Rachinskii, Sergei Aleksandrovich"] ,
        ...
        ["Steele, Richard, Sir", "Steele, Richard, Sir"] ,
...
var classics_PROPERTIES = [
    ["bibliography.congress classifications", "bibliography.congress classifications"] ,
    ["bibliography.languages", "bibliography.languages"] ,
    ["bibliography.subjects", "bibliography.subjects"] ,
    ["bibliography.title", "bibliography.title"] ,
    ["bibliography.type", "bibliography.type"] ,
    ["metadata.downloads", "metadata.downloads"] ,
    ["metadata.id", "metadata.id"] ,
    ["metadata.rank", "metadata.rank"] ,
    ["metadata.url", "metadata.url"] ,
    ["bibliography.author.birth", "bibliography.author.birth"] ,
    ["bibliography.author.death", "bibliography.author.death"] ,
    ["bibliography.author.name", "bibliography.author.name"] ,
    ["bibliography.publication.day", "bibliography.publication.day"] ,
    ["bibliography.publication.full", "bibliography.publication.full"] ,
    ["bibliography.publication.month", "bibliography.publication.month"] ,
    ["bibliography.publication.month name", "bibliography.publication.month name"] ,
    ["bibliography.publication.year", "bibliography.publication.year"] ,
    ["metadata.formats.total", "metadata.formats.total"] ,
    ["metadata.formats.types", "metadata.formats.types"] ,
    ["metrics.difficulty.automated readability index", "metrics.difficulty.automated readability index"] ,
    ["metrics.difficulty.coleman liau index", "metrics.difficulty.coleman liau index"] ,
    ["metrics.difficulty.dale chall readability score", "metrics.difficulty.dale chall readability score"] ,
    ["metrics.difficulty.difficult words", "metrics.difficulty.difficult words"] ,
    ["metrics.difficulty.flesch kincaid grade", "metrics.difficulty.flesch kincaid grade"] ,
    ["metrics.difficulty.flesch reading ease", "metrics.difficulty.flesch reading ease"] ,
    ["metrics.difficulty.gunning fog", "metrics.difficulty.gunning fog"] ,
    ["metrics.difficulty.linsear write formula", "metrics.difficulty.linsear write formula"] ,
    ["metrics.difficulty.smog index", "metrics.difficulty.smog index"] ,
    ["metrics.sentiments.polarity", "metrics.sentiments.polarity"] ,
    ["metrics.sentiments.subjectivity", "metrics.sentiments.subjectivity"] ,
    ["metrics.statistics.average letter per word", "metrics.statistics.average letter per word"] ,
    ["metrics.statistics.average sentence length", "metrics.statistics.average sentence length"] ,
    ["metrics.statistics.average sentence per word", "metrics.statistics.average sentence per word"] ,
    ["metrics.statistics.characters", "metrics.statistics.characters"] ,
    ["metrics.statistics.polysyllables", "metrics.statistics.polysyllables"] ,
    ["metrics.statistics.sentences", "metrics.statistics.sentences"] ,
    ["metrics.statistics.syllables", "metrics.statistics.syllables"] ,
    ["metrics.statistics.words", "metrics.statistics.words"] 
]
...
Blockly.Blocks['classics_get'] = {
  ...
  mutationToDom: function() {
    ...
    container.setAttribute('module', "classics")
    return container;
  },
...
BlockMirrorTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['classics'] = {
    "get": {
        custom: function(node, parent) {
            ...
            return BlockMirrorTextToBlocks.create_block("classics_get", null,
