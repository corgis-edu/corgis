---
permalink: /visualizer/state_crime/
style: dataset
extras: visualizer
---

<img class="img-thumbnail float-right"
     src="../../datasets/visualizer/state_crime/state-crime-splash.png"
     alt="state crime icon"
     role="presentation">

# State Crime Visualizer
...
<script src='../../datasets/visualizer/state_crime/state_crime.js'></script>
<script src='../../datasets/visualizer/state_crime/state_crime_bar.js'></script>