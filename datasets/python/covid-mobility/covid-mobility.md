---
permalink: /python/covid-mobility/
style: dataset
---
...
1. <a href='../../datasets/python/covid-mobility/covid-mobility.py' download>covid-mobility.py <span class="fas fa-download"></span></a>
2. <a href='../../datasets/python/covid-mobility/covid-mobility.data' download>covid-mobility.data <span class="fas fa-download"></span></a>

# Usage

```python
import covid-mobility
report = covid-mobility.get_report()
```
