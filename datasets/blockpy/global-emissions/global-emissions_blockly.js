...
var global-emissions_INDEX_VALUES = {
    "(None)": [],
...
var global-emissions_PROPERTIES = [
    ["Year", "Year"] ,
    ["Country.Name", "Country.Name"] ,
...
Blockly.Blocks['global-emissions_get'] = {
  init: function() {
    this.setColour(45);
    this.appendDummyInput('MAIN')
        .appendField("global-emissions.get")
        .appendField(new Blockly.FieldDropdown(global-emissions_PROPERTIES), "PROPERTY");
    this.appendDummyInput('SECOND')
        .appendField("filter")
        .appendField(new Blockly.FieldDropdown(global-emissions_INDEXES, function(option) {
  ...
  mutationToDom: function() {
    ...
    container.setAttribute('module', "global-emissions")
    return container;
  },
  ...
  updateShape_: function(index, index_value) {
    ...
    try {
        if (index != undefined && index != '(None)') {
            inputGroup.appendField(new Blockly.FieldDropdown(global-emissions_INDEX_VALUES[index]), 'INDEX_VALUE')
            if (index_value != undefined) {
                this.setFieldValue(index_value, 'INDEX_VALUE');
            } else {
                this.setFieldValue(global-emissions_INDEX_VALUES[index][0][0], 'INDEX_VALUE');
            }
        }
    } catch (e) {
...
Blockly.Python['global-emissions_get'] = function(block) {
    Blockly.Python.definitions_['import_global-emissions'] = 'import global-emissions';
    ...
    var code = 'global-emissions.get('+property+',' +index+','+index_value+')';
    return [code, Blockly.Python.ORDER_ATOMIC];
};

BlockMirrorTextToBlocks.prototype.MODULE_FUNCTION_SIGNATURES['global-emissions'] = {
    "get": {
        custom: function(node, parent) {
            ...
            return BlockMirrorTextToBlocks.create_block("global-emissions_get", null,
...
BlockMirrorBlockEditor.EXTRA_TOOLS['Data - global-emissions'] = '<category name="Data - Global-Emissions" colour="45">'+
                    '<block type="global-emissions_get"><mutation index="(None)" index_value=""></mutation></block>'+
                '</category>';