---
permalink: /visualizer/construction_permits/
style: dataset
extras: visualizer
---
...
# Construction Permits Visualizer
...
<script>
DATASET_NAME = "construction_permits";
DATASET_ROW = "permit";
</script>
...
<script src='../../datasets/visualizer/construction_permits/construction_permits.js'></script>
<script src='../../datasets/visualizer/construction_permits/construction_permits_bar.js'></script>